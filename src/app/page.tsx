    ...
    <main>
      <section className="relative isolate overflow-hidden bg-[#F7EFE6] px-6 py-16 sm:py-20 lg:py-24">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="rounded-lg border border-[#C05A3C]/10 bg-white p-6 shadow-[0_24px_80px_-56px_rgba(44,24,16,0.75)]">
            <div className="rounded-lg bg-[#8B3A24] p-6 text-white">
            ...
            <dl className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-2">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {programs.map((program) => (
              <article
                key={program.slug}
                className="flex min-h-full flex-col rounded-lg border border-[#C05A3C]/10 bg-white p-6 shadow-sm"
              >
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-lg bg-white p-6 text-[#2C1810]">
            ...
            <p className="mt-4 text-sm leading-6 text-muted-foreground">
              ...
              school, church, company, or community group, we would also love to
              hear from you.
            </p>
